...
st.set_page_config(layout="wide", page_title="DA Face Recognition app", page_icon=":sunglasses:")

# Title
st.title(" INSA DA CAC Webcam Face Recognition app")
...
with st.sidebar:
    st.image("logo.png")
    d = st.date_input("Today is :", value=None)
...
with st.container():
    ...
    # except:
    #     st.error("There is a problem with your webcam. Try a different Browser or device.") My new app")
st.write(
